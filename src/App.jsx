...
import { routeSeo } from './utils/seo.js'
...
export default function App() {
  ...
  useEffect(() => {
    routeSeo(path, publicBundle?.profile || profile)
  }, [path, profile?.username, profile?.display_name, profile?.bio, publicBundle?.profile?.username])
